...
public class Cannon : VoxelData {
	...
	void fire(){
		...
		GameObject g = GameObject.Instantiate(TextureHolder.Instance.bulletPrefab, globalPos+direction.normalized*1.1f, Quaternion.Euler(new Vector3(0,0,rotation))) as GameObject;
